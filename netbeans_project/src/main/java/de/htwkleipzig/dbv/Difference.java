...
public class Difference implements PlugIn {
	...
	private static final String[] operators = {"Add","Subtract","Multiply","Divide", "AND", "OR", "XOR", "Min", "Max", "Average", "Difference", "Copy", "Transparent-zero", "2.3a-or","2.3b-and","2.3c-sub","2.3d-xor"};
	private static final String[] lcOperators = {"add","sub","mul","div", "and", "or", "xor", "min", "max", "ave", "diff", "copy", "zero", "2.3a-or","2.3b-and","2.3c-sub","2.3d-xor"};
	...
	public void run(String arg) {
            ...
            switch (lcOperators[operator]) {
                case "2.3a-or":
                    CreateSplitImage(img1, img2, "OR create");
                    break;
                case "2.3b-and":
                    CreateSplitImage(img1, img2, "AND create");
                    break;
                case "2.3c-sub":
                    CreateSplitImage(img1, img2, "Subtract create");
                    break;
                case "2.3d-xor":
                    CreateSplitImage(img1, img2, "XOR create");
                    break;
                default:
                    ImageCalculator ic = new ImageCalculator();
                    ImagePlus img3 = ic.run(operators[operator] + " create", img1, img2);
    ...
    private void CreateSplitImage(ImagePlus img1, ImagePlus img2, String create) {
        ...
        img3 = ChannelSplitter.split(RGBStackMerge.mergeChannels(arrayMerge_b, true))[1];
