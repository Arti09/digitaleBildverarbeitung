...
public class ShapeCheck implements PlugInFilter
{
    ...
    /**
        ...
        @param: x0,y0 Anfangskoordinaten des Bereiches in dem das Verkehrszeichen sich befindet
        @param: w,h die Breite und die Höhe des  des Bereiches in dem das Verkehrszeichen sich befindet
        @return: den Wert 0, 1, 2 oder -1. 0:= Ellipse, 1 := Dreieck, 2:= Rechteck, -1:= Fehler
     */
