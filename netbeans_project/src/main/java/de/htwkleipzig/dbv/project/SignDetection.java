...
public class SignDetection implements PlugInFilter {
    ...
    public void run(ImageProcessor ip) {
        ...
        gd.addNumericField("Picture Segmentation - Min pixel in a group: ", min_seg, 0);
        gd.showDialog();
        ...
        ImageProcessor ipp = segementByColor("RED".equals(color) ? Glob.SHIFTMASK_RED : "BLUE".equals(color) ? Glob.SHIFTMASK_BLUE : Glob.SHIFTMASK_GREEN, mask_factor);
